const aktuality = [
    ...
    {
      title: "Slevy na příslušenství!",
      description: "Využijte naší aktuální nabídky slev na cyklistické příslušenství. Najdete u nás helmy, zámky, blatníky, pumpy a další potřebné vybavení.",
      image: "/images/aktuality/medvidek.jpg"
    },
    {
      title: "Bezpečnost na prvním místě!",
      description: "Jezdíte rádi za tmy? Nezapomeňte na bezpečnostní vybavení! Nabízíme široký výběr cyklistických přileb, reflexních vest a světel. Vaše bezpečnost je naší prioritou!",
      image: "/images/aktuality/helma.jpg"
    },
  ];  
